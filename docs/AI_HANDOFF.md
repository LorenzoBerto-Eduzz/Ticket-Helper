...
- Current extension version: `1.9.10`.
...
- Before a manual action runs after focusing its BO tab, the background waits/retries for the BO tab to be awake/injectable. This avoids first-click misses when Chrome has left the BO tab idle/discarded or just refocused.
