...
- Current extension version: `1.9.3`.
...
- Version `1.9.3` builds on the `1.9` stabilization model, the `1.9.1` HubSpot email-gather reliability work, and the `1.9.2` producer warnings.
